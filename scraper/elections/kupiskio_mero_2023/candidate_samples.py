...
from scraper.elections.kupiskio_mero_2023.sitemap import ELECTION_ID, resolve_candidate_url
...
# ("...deklaracijos"), matching the 2024 layout. Unlike the 2024 presidential
# pages, candidate pages here do carry a campaign tab.
EXPECTED_TABS = {
    "anketa",
    "biografija",
