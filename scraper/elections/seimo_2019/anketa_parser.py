...
from scraper.elections.seimo_2019.sitemap import ELECTION_ID
# The candidate pages are the 2016 Seimo layout, the same as the April 2017
# by-election: one anketa table with the whole Q5-Q21 set, the elected note
...
DEFAULT_OUTPUT_ROOT = Path("data/2019-rugsejo-8-seimo")
