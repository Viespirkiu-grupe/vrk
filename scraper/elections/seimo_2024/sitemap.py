...
ELECTION_ID = "2024-seimo"
LISTING_URL = (
    "https://www.vrk.lt/kandidatai-kandidatu-sarasai-2024-sei"
    "?srcUrl=/rinkimai/1544/rnk1870/kandidatai/SeiKandidataiPilnasSarasas.html"
)
VRK_STATINIAI_BASE = "https://www.vrk.lt/statiniai/puslapiai/"

DEFAULT_SAMPLE_PATH = Path("samples/html/2024-seimo/list.html")
DEFAULT_WRAPPER_SAMPLE_PATH = Path("samples/html/2024-seimo/page.html")
DEFAULT_SITEMAP_PATH = Path("sitemaps/2024-seimo.json")
