...
from scraper.elections.ep_2024.sitemap import ELECTION_ID, resolve_candidate_url
...
# EP candidate tabs. As in 2019, both declaration tabs are pluralised
# ("...deklaracijos"). No campaign tab was observed on 2024 EP candidate
# pages (campaigns were run by the party lists), but the campaign fetch
# machinery below stays active in case one appears.
EXPECTED_TABS = {
    "anketa",
    "biografija",
