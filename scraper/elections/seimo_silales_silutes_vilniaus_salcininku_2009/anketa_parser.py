...
from scraper.elections.seimo_silales_silutes_vilniaus_salcininku_2009.sitemap import ELECTION_ID
...
# 2013 repeat-election module — the same pages, the same single-constituency
# candidacy. Nothing here is this election's own.
