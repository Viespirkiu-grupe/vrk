...
from scraper.elections.marijampoles_mero_2017.sitemap import ELECTION_ID, resolve_candidate_url
# Same era, same dead treasurer links: this election reuses the April 2017
# campaign-URL fallback rather than restating it.
from scraper.elections.meru_2017.candidate_samples import _fetch_campaign_page
from scraper.shared.anomalies import build_anomaly_event
from scraper.shared.files import slugify
from scraper.shared.http import fetch_text

DEFAULT_SITEMAP_PATH = Path("sitemaps/2017-rugsejo-10-marijampoles-mero.json")
