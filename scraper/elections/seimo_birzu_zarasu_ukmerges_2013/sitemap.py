...
def fetch_listing_sample(
    ...
    # skipping files already on disk so an interrupted capture resumes. The
    # index file name is a parameter because the 2012 general election keeps
    # two indexes (lists and constituencies) in one samples directory.
