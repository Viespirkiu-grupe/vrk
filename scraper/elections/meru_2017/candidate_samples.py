...
from scraper.elections.meru_2017.sitemap import ELECTION_ID, resolve_candidate_url
...
DEFAULT_SITEMAP_PATH = Path("sitemaps/2017-balandzio-23-meru.json")
DEFAULT_SAMPLES_ROOT = Path("samples/html/2017-balandzio-23-meru")

# Mayoral candidate tabs. Both declaration tabs are pluralised
# ("...deklaracijos"), as in every later mayoral election, and candidate pages
# carry a campaign tab.
EXPECTED_TABS = {
    "anketa",
    "biografija",
