"""Candidate record parsing for the 1997-12-21 Seimo repeat election."""
...
from scraper.elections.seimo_aukstaitijos_1997_gruodzio.candidate_samples import DEFAULT_SAMPLES_ROOT
