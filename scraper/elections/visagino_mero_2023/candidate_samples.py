...
from scraper.elections.visagino_mero_2023.sitemap import ELECTION_ID, resolve_candidate_url
...
DEFAULT_SITEMAP_PATH = Path("sitemaps/2023-geguzes-7-visagino-mero.json")
...
# ("...deklaracijos"), matching the 2024 layout. The campaign tab is not
# expected: this repeat vote re-runs the March 2023 mayoral runoff, so neither
# candidate page publishes one — their campaign finance is published with the
# 2023-kovo-5 municipal election. It would still be fetched if present.
EXPECTED_TABS = {
    "anketa",
    "biografija",
