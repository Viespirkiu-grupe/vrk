...
from scraper.elections.visagino_mero_2023.sitemap import ELECTION_ID
# The pages are the same vintage as the October 2023 Kupiškis mayoral election,
# down to the space-numbered questions ("10 ."), the hyphen-separated Q13.4
# conviction details, the 2020-numbered biography and the <div>-wrapped tab
# bodies, so the parsing rules are reused rather than restated here.
...
DEFAULT_OUTPUT_ROOT = Path("data/2023-geguzes-7-visagino-mero")
