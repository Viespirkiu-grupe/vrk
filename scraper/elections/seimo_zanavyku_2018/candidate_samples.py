...
from scraper.elections.seimo_zanavyku_2018.sitemap import ELECTION_ID, resolve_candidate_url
from scraper.shared.anomalies import build_anomaly_event
from scraper.shared.files import slugify
from scraper.shared.http import fetch_text

DEFAULT_SITEMAP_PATH = Path("sitemaps/2018-rugsejo-16-seimo-zanavykai.json")
