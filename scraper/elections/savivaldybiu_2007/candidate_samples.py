...
# Three tabs for everyone — the family's smallest set. No Biografija (the
# 2007 Seimo pages have one; these council pages do not), no Kita (first
# published in 2008), and no campaign participant link on the card: the
# 2007 municipal pages publish none, as the 2008 Seimo and 2011 municipal
# pages do not.
EXPECTED_TABS = {
    "anketa",
