...
LISTING_URL = (
    "https://www.vrk.lt/2020-sei/kandidatai"
    "?srcUrl=/rinkimai/1104/rnk1424/kandidatai/SeiKandidataiPilnasSarasas.html"
)
VRK_STATINIAI_BASE = "https://www.vrk.lt/statiniai/puslapiai/"

DEFAULT_SAMPLE_PATH = Path("samples/html/2020-seimo/list.html")
DEFAULT_WRAPPER_SAMPLE_PATH = Path("samples/html/2020-seimo/page.html")
DEFAULT_SITEMAP_PATH = Path("sitemaps/2020-seimo.json")
