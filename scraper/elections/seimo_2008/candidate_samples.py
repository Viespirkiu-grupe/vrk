...
# The 2008 candidate pages carry four tabs: the era's five without "Kita"
# (no Kandidato<ID>Kita.html exists — the tab is neither linked nor
# published). Nor does the profile card link a campaign participant page:
# VRK's 2008 participants index (400_lt/PolitiniuKampanijuFinansavimas/)
# lists the parties, but no candidate page links it, so the records carry
# no campaign section.
