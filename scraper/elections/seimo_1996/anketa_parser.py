"""Candidate record parsing for the 1996-10-20 Seimas general election."""
...
from scraper.elections.seimo_1996.candidate_samples import DEFAULT_SAMPLES_ROOT
from scraper.elections.seimo_1996.sitemap import DEFAULT_SITEMAP_PATH, ELECTION_ID
...
# VRK's results pages when the file exists; see `results.py`.
