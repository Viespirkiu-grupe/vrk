...
from scraper.elections.ep_2019.sitemap import ELECTION_ID, resolve_candidate_url
...
# EP candidate tabs. Note that the private interest tab is pluralised
# ("...deklaracijos") in this election, unlike the Seimo modules.
EXPECTED_TABS = {
    "anketa",
    "biografija",
...
def _label_slug_from_url(url: str) -> str:
    ...
    stem = stem.replace("epKandidatas", "")
    stem = stem.strip("-")
    return slugify(stem)
