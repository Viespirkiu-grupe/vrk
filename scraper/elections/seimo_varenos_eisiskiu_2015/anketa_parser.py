...
from scraper.elections.seimo_varenos_eisiskiu_2015.sitemap import ELECTION_ID
# Same pre-2016 layout family as the March 2015 Žirmūnai by-election, Seimo
# question variant included, so the era parsers run under this election's id.
