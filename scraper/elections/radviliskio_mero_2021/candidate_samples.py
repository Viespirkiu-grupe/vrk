...
from scraper.elections.radviliskio_mero_2021.sitemap import ELECTION_ID, resolve_candidate_url
# Campaign tabs are linked through the treasurer page, as in 2017, so the same
# fallback applies when a party-represented participant has no such page.
...
DEFAULT_SITEMAP_PATH = Path("sitemaps/2021-balandzio-11-radviliskio-mero.json")
...
# ("...deklaracijos") and candidate pages carry a campaign tab.
EXPECTED_TABS = {
    "anketa",
    "biografija",
