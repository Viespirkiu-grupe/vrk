...
ELECTION_ID = "2021-balandzio-11-radviliskio-mero"
LISTING_URL = (
    "https://www.vrk.lt/kandidatai-i-savivaldybes-tarybos-narius-merus-2021-radviliskio-mero"
    "?srcUrl=/rinkimai/1144/rnk1464/kandidatai/savKandidataiMerai.html"
)
VRK_STATINIAI_BASE = "https://www.vrk.lt/statiniai/puslapiai/"

DEFAULT_SAMPLE_PATH = Path("samples/html/2021-balandzio-11-radviliskio-mero/list.html")
DEFAULT_WRAPPER_SAMPLE_PATH = Path("samples/html/2021-balandzio-11-radviliskio-mero/page.html")
DEFAULT_SITEMAP_PATH = Path("sitemaps/2021-balandzio-11-radviliskio-mero.json")

# Municipal candidate anketa links use the "savKandidatasAnketa" file stem; the
# marker below is the substring shared with the other modules.
