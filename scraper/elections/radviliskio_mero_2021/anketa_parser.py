...
from scraper.elections.radviliskio_mero_2021.sitemap import ELECTION_ID
# The pages are the same vintage as the October 2021 mayoral elections, down to
# the question numbering, the dotless Q7.1, the Q9.1 conviction table and the
# <div>-wrapped tab bodies, so the parsing rules are reused rather than restated
# here.
from scraper.elections.meru_2021.anketa_parser import parse_anketa_html
