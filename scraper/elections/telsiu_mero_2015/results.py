...
# Mayor only (no lists), decided in round two. The composition tree is
# the March election's, whose Telšiai page carries the November mayor.
RESULTS_TREE = "2015_4_savivaldybiu_tarybu_rinkimai"
