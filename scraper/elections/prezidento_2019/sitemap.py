...
LISTING_URL = (
    "https://www.vrk.lt/kandidatai-i-respublikos-prezidentus-2019-pr"
    "?srcUrl=/rinkimai/904/rnk1184/kandidatai/preKandidatai.html"
)
VRK_STATINIAI_BASE = "https://www.vrk.lt/statiniai/puslapiai/"

DEFAULT_SAMPLE_PATH = Path("samples/html/2019-prezidento/list.html")
DEFAULT_WRAPPER_SAMPLE_PATH = Path("samples/html/2019-prezidento/page.html")
DEFAULT_SITEMAP_PATH = Path("sitemaps/2019-prezidento.json")

# The presidential candidate anketa links point at preKandidatasAnketa pages.
CANDIDATE_LINK_MARKER = "preKandidatasAnketa"
