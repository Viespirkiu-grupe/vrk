...
from scraper.elections.seimo_2016.sitemap import ELECTION_ID
# The page family's readers and normalizers -- the profile card, the anketa
# table, every tab and the campaign samples -- live in
# scraper/shared/anketa_tabs.py, which the other 35 election modules that
# read these pages import from too (issue #90). What stays here is how this
# election assembles its record.
