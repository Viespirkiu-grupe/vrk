"""Candidate record parsing for the 1998-11-15 Seimo repeat election."""
...
from scraper.elections.seimo_nevezio_1998_lapkricio.candidate_samples import DEFAULT_SAMPLES_ROOT
