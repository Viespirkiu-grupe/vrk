...
SAMPLES_ROOT = REPO_ROOT / "samples" / "html" / "2009-ep"
# One fixture per list: the fifteen list leaders. The full 262-candidate field
# is scraped by scripts/run_election_batches.sh, not kept as fixtures.
...
# The list index plus the fifteen list pages the sitemap walks (lists/list-<id>.html).
...
class Ep2009SampleAllowlistTests(unittest.TestCase):
