...
# The one a clone carries: `party-lists/` is 6.2 MB across 564 pages and
# `municipalities/` 4.4 MB across 60, both over the 1 MiB limit on a
# tracked fixture unit (scripts/tracked_fixtures.py).
