...
# The ones a clone carries: `lists/` is 3.6 MB across 651 party-list pages,
# over the 1 MiB limit on a tracked fixture unit
# (scripts/tracked_fixtures.py).
TRACKED_SUPPORT_DIRS = {"municipalities", "parties"}
